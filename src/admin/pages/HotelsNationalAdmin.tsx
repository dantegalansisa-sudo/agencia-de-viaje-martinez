...
export default function HotelsNationalAdmin() {
  const { data, loading, add, update, remove } = useCollection<Hotel>('hotelsNational', false);
    ...
    <div>
      <div className="adm-topbar">
        <div className="admin-page__header" style={{ marginBottom: 0 }}>
          <h1 className="admin-page__title">Hoteles Nacional</h1>
          <p className="admin-page__sub">Hoteles todo incluido en República Dominicana</p>
        </div>
