...
export default function ContactSection() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const text = `Hola Agencia de Viajes Martínez! Solicito cotización:\n- Nombre: ${form.nombre}\n- Teléfono: ${form.telefono}\n- Destino: ${form.destino}\n- Servicio: ${form.servicio}\n- Fecha: ${form.fecha}\n- Viajeros: ${form.viajeros}\n- Mensaje: ${form.mensaje}`;
    window.open(`https://wa.me/18095293515?text=${encodeURIComponent(text)}`, '_blank');
  };
            ...
            <div className="contact__details">
              <div className="contact__detail">
                ...
                <div>
                  ...
                  <a href="https://wa.me/18095293515" target="_blank" rel="noopener noreferrer">809-529-3515</a>
                </div>
              </div>
              <div className="contact__detail">
                <span className="contact__detail-icon">📍</span>
                <div>
                  ...
                  <span>Calle Duarte #33, San Pedro de Macorís, Rep. Dom.</span>
                </div>
              </div>
              <div className="contact__detail">
                <span className="contact__detail-icon">📷</span>
                <div>
                  ...
                  <a href="https://instagram.com/agenciadeviajesmartinez" target="_blank" rel="noopener noreferrer">@agenciadeviajesmartinez</a>
                </div>
              </div>
            </div>
